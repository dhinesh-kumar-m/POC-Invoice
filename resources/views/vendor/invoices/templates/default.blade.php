...
<html lang="en">
    ...
    <body>
        {{-- Header --}}
        @if($invoice->logo)
            <img class="logoright" src="{{ $invoice->getLogo() }}" alt="logo" height="100">
        @endif
        ...
        <div >  
            <P class="footer1" >ALBA MOTORS FZC
            </P> 
            <p class="footer2">www.albacars.ae</p>
            <p class="footer3">abc@example.com</p>
            <!-- <a class="footer2" href = "www.albacars.ae" >www.albacars.ae</a>
            <a class="footer3" href = "mailto: abc@example.com">abc@example.com</a> -->
